...
const WorkspaceDestinationSetting: Component = () => {
  ...
  const options = createMemo(() => [
    { value: "last-used" as const, label: language.t("settings.workspaces.default.lastUsed") },
    { value: "local" as const, label: language.t("settings.workspaces.default.local") },
    { value: "new" as const, label: language.t("settings.workspaces.default.new") },
  ])
